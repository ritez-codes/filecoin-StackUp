        ...
        <div style={{ display: "flex" }}>
          <div className={styles.activeDataDaoContainer}>
            ...
            <div>
              ...
              >
                <h3
                  style={{ color: "white", padding: "4px", fontWeight: "bold" }}
                >
                  Results
                </h3>
              </div>
    ...
    <>
      ...
      <div className={styles.bottomBody}>
                          ...
                          <div>
                            ...
                            <div className={styles.voteResultsContainer}>
                              <div style={{ color: "white", padding: "10px" }}>
                                Current Dataset Stored: Research.json File
                              </div>
                            </div>
                          </div>
                        </div>
        ...
        <footer className={styles.footer2}>
          <p>
            Capstone Project for the StackUp x Filecoin Collaboration | Brought
            to you by StackUp
          </p>
          <img
            src="https://s3.amazonaws.com/appforest_uf/f1678711565785x238031668364268480/Frame%205stackoin%20%281%29.png"
            width="50px"
          />
          <img
